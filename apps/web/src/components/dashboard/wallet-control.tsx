...
export function WalletControl() {
  ...
  if (chainId !== coston2.id) return <button className="wallet-button wrong" aria-label="Switch connected wallet to Coston2" onClick={() => switchChain({ chainId: coston2.id })}>Switch to Coston2</button>;
